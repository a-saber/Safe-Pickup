      ...
      body: SafeArea(
        child: FutureBuilder<DocumentSnapshot>(
          ...
          builder: (BuildContext context, AsyncSnapshot<DocumentSnapshot> guardianSnapshot) {
            ...
            {
              ParentModel guardian = ParentModel.fromJson(guardianSnapshot.data!.data() as Map<String, dynamic>);
              return Column(
                ...
                [
                  ...
                  stream: FirebaseFirestore.instance
                      ...
                      .collection(CollectionManager.parentsCollection)
                      .doc(guardianId).collection(CollectionManager.kidsCollection)
                      .snapshots(),
                                ...
                                ElevatedButton(
                                  onPressed: ()async
                                  {
                                    await FirebaseFirestore.instance.collection(CollectionManager.schoolsCollection)
                                        .doc(FirebaseAuth.instance.currentUser!.uid).collection(CollectionManager.parentsCollection)
                                        .doc(guardianId).collection(CollectionManager.kidsCollection)
